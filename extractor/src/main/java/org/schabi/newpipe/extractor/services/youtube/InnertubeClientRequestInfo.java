    ...
    public static InnertubeClientRequestInfo ofAndroidVrClient() {
        return new InnertubeClientRequestInfo(
                new InnertubeClientRequestInfo.ClientInfo(ANDROID_VR_CLIENT_NAME,
                        ANDROID_VR_CLIENT_VERSION, ANDROID_VR_CLIENT_ID, WATCH_CLIENT_SCREEN,
                        null),
                new InnertubeClientRequestInfo.DeviceInfo(MOBILE_CLIENT_PLATFORM, "Oculus",
                        "Quest 3", "Android", "12L", 32));
    }
